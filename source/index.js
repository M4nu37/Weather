...
function findWeather() {
    ...
    .then(data=> { console.log(data); 
        ...
        document.getElementById('status').innerHTML = weatherName;


        function displayWeather(fileName, imgDestination, tempDestination) { //Function to display the image and temperature for the next days

            let forecastImg = `<img src="`+fileName+`" height="100px" alt="foto">`;
            document.getElementById(imgDestination).innerHTML = forecastImg;

            let forecastTemp = Math.round(data.main.temp) + 'ºC' ;
        ...
        .then(timeData=> { console.log(timeData); 
            ...
            document.getElementById('hour').innerHTML = localHour+ ':' +m;
        });
    ...
    .then(data=> { console.log(data);
        ...
        function displayForecast(fileName, imgDestination, tempDestination, num) { //Function to display the image and temperature for the next days
            ...
            let forecastImg = `<img src="`+fileName+`" height="60px" alt="foto">`;
            document.getElementById(imgDestination).innerHTML = forecastImg;
        ...
        //Weekday display
        let days = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday'];
        let d = new Date();
